...
for (const file of ['features/nexacrm/components/data-table/record-view-bar.tsx', 'features/nexacrm/components/data-table/data-table-view-options.tsx', 'features/nexacrm/components/calendar/record-calendar.tsx']) assert.match(read(file), /SearchableMenuSection/)

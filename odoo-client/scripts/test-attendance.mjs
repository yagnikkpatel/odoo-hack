...
assert.match(read('features/employees/employee-panel.tsx'), /EmployeeAttendance/)
assert.match(read('features/employees/employee-detail.tsx'), /EmployeeAttendance/)
assert.match(read('features/employees/components/employee-fields.tsx'), /EmployeeSchedule/)
